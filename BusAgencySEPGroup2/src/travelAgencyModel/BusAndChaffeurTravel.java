 ...
 * personCount to be included. Implements {@link Serialization} by extension.
 * 
 * @author DVN
 *
 */
public class BusAndChaffeurTravel extends Travel
{
	 ...
	 * 
	 * @param customer
	 *            The {@link Customer} making the reservation.
	 * @param bus
	 *            The {@link Bus} assigned the reservation.
	 * @param chauffeur
	 *            The {@link Chauffeur} assigned the reservation.
	 * @param personCount
	 *            The expected or maximum amount of passengers this reservation
	 *            covers.
	 ...
	 * {@link BusAndChauffeurTravel}. Suitable for a TextArea.
	 * 
	...
	public String getText()
	{
		...
		text += "\t" + customer.getName() + " - Phone: " + customer.getPhoneNumber()
