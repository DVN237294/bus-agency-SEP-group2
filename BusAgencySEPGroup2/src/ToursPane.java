...
public class ToursPane extends JPanel
{
   ...
   public ToursPane(TravelAgency agency)
   {
      ...
      destinationBox = new JExtendedComboBox<String>(
            agency.getAllDestinations());
      ...
      chauffeurBox.setDefaultDisplayedItem(new Chauffeur("Chauffeur", null,
            Integer.MIN_VALUE)); // is this cheating?
   ...
   private class SearchAction implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         ...
         Travel[] searchResult = agency.searchTravel(
               destinationBox.getSelectedItem(),
               chauffeurBox.getSelectedItem(), busBox.getSelectedItem());
         DefaultListModel<Tour> listModel = (DefaultListModel<Tour>) centerWestList
               .getModel();
         listModel.clear();
